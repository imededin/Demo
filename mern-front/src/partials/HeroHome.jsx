      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 relative">
        ...
        <div className="relative pt-32 pb-10 md:pt-40 md:pb-16">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            ...
            Wamya is the best solution for companies looking to optimize their operations
            </h1>
            <p className="text-xl text-gray-600 mb-8" data-aos="fade-up" data-aos-delay="200">
            Wamya is a user-friendly, one-click solution that simplifies project deployment. With just a few clicks, you can easily run your application in production
            </p>
            <div className="max-w-xs mx-auto sm:max-w-none sm:flex sm:justify-center">
              <div data-aos="fade-up" data-aos-delay="400">
                <a className="btn text-white bg-purple-600 hover:bg-purple-700 w-full mb-4 sm:w-auto sm:mb-0" href="/home">
                  Start free trial
                </a>
          ...
          <div>
            ...
            <Modal id="modal" ariaLabel="modal-headline" show={videoModalOpen} handleClose={() => setVideoModalOpen(false)}>
              ...
              <iframe className="absolute w-full h-full" src="https://player.vimeo.com/video/800946283?h=804c85bd4b" width="640" height="564" frameborder="0" allow="autoplay; fullscreen" allowfullscreen></iframe>
              </div>
            </Modal>
          </div>
        </div>
